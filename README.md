...
| **6. Copy formulas** | Copies the source column's formulas → target column using `Range.Copy(Destination=...)`. This is the core operation — equivalent to dragging the formula column in Excel |
